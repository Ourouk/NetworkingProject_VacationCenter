...
auth_server: $(SRC)/auth_server.cpp Customer.o Customers.o Command.o
	$(COMPILER_CPP) $(CFLAGS) $(SRC)/auth_server.cpp $(TARGET)/Customer.o $(TARGET)/Customers.o $(TARGET)/Command.o -o $(TARGET)/auth_server

auth_client: $(SRC)/auth_client.cpp Customer.o Customers.o Command.o
	$(COMPILER_CPP) $(CFLAGS) $(SRC)/auth_client.cpp $(TARGET)/Customer.o $(TARGET)/Customers.o $(TARGET)/Command.o -o $(TARGET)/auth_client
