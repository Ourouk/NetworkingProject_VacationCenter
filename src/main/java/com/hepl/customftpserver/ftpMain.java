...
public class ftpMain implements Runnable{
    ...
    public void run() {
        ...
        socketListener listener_thread = new socketListener(listen_port,4);
        ...
        secureSocketListener SSLlistener_thread = new secureSocketListener(ssl_listen_port,4,false);
